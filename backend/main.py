...
# Remove cohere import since we're using local embeddings
...
class DocusaurusEmbeddingPipeline:
    def __init__(self):
        ...
        self.target_url = "https://maryamhussan.github.io/Physical-AI-And-Humanoid-Robotics"
    ...
    def get_all_urls(self, base_url: str) -> List[str]:
        ...
        try:
            # Define the allowed domain to ensure we only crawl the intended site
            allowed_domain = "maryamhussan.github.io"

            # Try to get URLs from sitemap first
            # Use the full sitemap URL for this specific site
            ...
            if response.status_code == 200:
                ...
                if root.tag.endswith('sitemapindex'):
                    ...
                    for sitemap in root.findall('.//{http://www.sitemaps.org/schemas/sitemap/0.9}loc'):
                        ...
                        # Only process sitemaps from the allowed domain
                        if allowed_domain in sitemap_text:
                            sitemap_response = requests.get(sitemap_text)
                            if sitemap_response.status_code == 200:
                                ...
                                for url_elem in sitemap_root.findall('.//{http://www.sitemaps.org/schemas/sitemap/0.9}loc'):
                                    ...
                                    # Only add URLs from the allowed domain
                                    if allowed_domain in url_text:
                ...
                for link in soup.find_all('a', href=True):
                    ...
                    # Only add URLs from the specific allowed domain
    ...
    def create_collection(self, collection_name: str = "rag_embedding"):
        ...
        try:
            ...
            # Create collection with appropriate vector size (384 for local all-MiniLM-L6-v2 embeddings)
